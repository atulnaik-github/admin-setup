    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="<?= site_url('assets/commonarea/'); ?>dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
        </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?= site_url('change-password')?>"><i class="fa fa-circle-o"></i> Change Password</a></li>
            <li><a href="<?= site_url('login')?>"><i class="fa fa-circle-o"></i> Logout</a></li>
          </ul>
        </li>
      </ul>
    </section>
